...
namespace Watermark.Shared.Models
{
    public static class ClientInstance
    {
        ...
        public static Action<WMCanvas, WMLogo, Dictionary<string, string>> SelectImageAction =
            (canvas, mLogo, ImagesBase64) => { };

        public static Action<WMCanvas, WMContainer, ConcurrentDictionary<string, string>> SelectContainerImageAction =
            (canvas, mContainer, ImagesBase64) => { };
        ...
        {
            var fontPath = AppDomain.CurrentDomain.BaseDirectory + "fonts" + System.IO.Path.DirectorySeparatorChar +
                           fontName;
        ...
        public static void WriteThumbnailImage(SKBitmap source, string target)
        {
            ...
            var xs = 1080.0 / h;
            var resized = source.Resize(new SkiaSharp.SKImageInfo((int)(w * xs), (int)(h * xs)),
        ...
        public static string GetAndroidId()
        {
            ...
            var deviceId =
 Android.Provider.Settings.Secure.GetString(context.ContentResolver, Android.Provider.Settings.Secure.AndroidId);
            return deviceId;
#endif
        ...
        {
            var version =
                await Connections.HttpGetAsync<WMClientVersion>(
                    APIHelper.HOST + $"/api/CloudSync/GetVersion?Client={client}", Encoding.Default);
        ...
        public static Dictionary<DevicePlatform, IEnumerable<string>> FileType = new()
        {
            ...
            { DevicePlatform.iOS, new[] { "image/jpg", "image/png" } },
            ...
            var action = new Action(async () =>
            {
                ...
                if (r)
                {
                    ...
                    if (!GlobalCache.DownloadedTemplates.Any()) GlobalCache.DownloadedTemplates.Add(dir);
                        ...
                        GlobalCache.DownloadedTemplates.Insert(0, dir);
                    else if (GlobalCache.DownloadedTemplates.Any(x => x.WatermarkId == dir.WatermarkId))
                    {
            ...
            , PageStackNavController NavController)
        {
            ...
            try
            {
                ...
                var configPath = Global.AppPath.TemplatesFolder + watermarkId + System.IO.Path.DirectorySeparatorChar +
                                 "config.json";
