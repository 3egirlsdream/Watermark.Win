...
namespace Watermark.Razor.Components
{
    ...
    /// </summary>
    public partial class ColorPicker2 : MudPicker<MudColor>
    {
        private readonly ParameterState<int> _throttleIntervalState;

        public ColorPicker2() : base(new DefaultConverter<MudColor>())
        {
        ...
        private ColorPickerView _activeColorPickerView = ColorPickerView.Grid;
